              ...
              <div className="modal-grid">
                ...
                <div className="modal-field" style={{ gridColumn: '1 / -1' }}>
                  <SelectDisponible label="Chofer" value={form.chofer} onChange={v => setF('chofer', v)}
                    opciones={[...(cfg.choferes || []), ...(cfg.operarios || []), ...(cfg.temporada || [])]} noDisponible={noDisponible} placeholder="— Seleccionar chofer —" requerido />
                </div>
                <div className="modal-field">
                  <SelectDisponible label="Ayudante 1" value={form.ay1} onChange={v => setF('ay1', v)}
                    opciones={[...(cfg.ayudantes || []), ...(cfg.operarios || []), ...(cfg.temporada || [])]} noDisponible={noDisponible} />
                </div>
                <div className="modal-field">
